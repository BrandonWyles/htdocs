...
<?php include ($svr.'inc/light/head_four.php'); ?>
...
<body>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown dropdown-hover active">
            ...
            <div class="dropdown-menu" style="width: 320px;">
              <ul role="menu">
                <li class="active"><a href="store-1.php">Store Style 1</a>
                </li>
  ...
  <!--
    ...
    rs-fullscreen
-->
  <div class="tp-banner-container rs-fire rs-fullscreen">
    <div class="tp-banner">
      <ul>
        <!-- SLIDE NR. 1  -->
        ...
        <!-- SLIDE NR. 2  -->
        <li data-thumb="assets/images/game-botanicula-1920x1080.jpg" data-saveperformance="on" data-transition="random-static" data-slotamount="7" data-masterspeed="700">
          <!-- MAIN IMAGE -->
        ...
        <!-- SLIDE NR. 3  -->
        <li data-thumb="assets/images/game-road-no-taken-1400x788.jpg" data-saveperformance="on" data-transition="random-static" data-slotamount="7" data-masterspeed="700">
          <!-- MAIN IMAGE -->
          <img src="assets/images/dummy.png" alt="" data-lazyload="assets/images/game-road-no-taken-1400x788.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
          <!-- LAYERS -->

          <!-- LAYER NR. 1 -->
          <div class="tp-caption customin customout" data-x="left" data-hoffset="60" data-y="center" data-voffset="-45" data-customin="x:200;scaleX:0.5;scaleY:0.5;" data-customout="x:0;scaleX:1;scaleY:1;" data-start="500" data-speed="700" data-easing="Sine.easeInOut"
          data-endspeed="600" data-endeasing="Linear.easeNone">
            <h2 class="h1">Road Not Taken</h2>
          </div>
  ...
  <section class="content-wrap">
    ...
    <div class="container fire-store store-grid">
      ...
      <div class="col-md-9 isotope">
        ...
        <div class="isotope-list row">
          ...
          <div class="item col-lg-4 col-md-6 col-xs-12" data-filters="specials">
            <a href="#!" class="angled-img">
              <div class="img img-offset">
                ...
                <div class="badge show bg-default">-25%</div>
              </div>
              <div class="bottom-info">
                <h4>Flower</h4>
                <div class="row">
          ...
          <div class="item col-lg-4 col-md-6 col-xs-12" data-filters="">
            <a href="#!" class="angled-img">
              <div class="img img-offset">
                <img src="assets/images/game-deponia-500x375.jpg" alt="">
              </div>
              <div class="bottom-info">
                <h4>Deponia</h4>
                <div class="row">
          ...
          <div class="item col-lg-4 col-md-6 col-xs-12" data-filters="popular">
            <a href="#!" class="angled-img">
              <div class="img img-offset">
                <img src="assets/images/game-dreamfall-chapters-500x375.jpg" alt="">
              </div>
              <div class="bottom-info">
                <h4>Dreamfall Chapters</h4>
                <div class="row">
                  <div class="col-xs-6">
                    <div class="rating">
                      <i class="fa fa-star"></i>
          ...
          <div class="item col-lg-4 col-md-6 col-xs-12" data-filters="popular">
            <a href="#!" class="angled-img">
              <div class="img img-offset">
                <img src="assets/images/game-flow-500x375.jpg" alt="">
              </div>
              <div class="bottom-info">
                <h4>flOw</h4>
                <div class="row">
          ...
          <div class="item col-lg-4 col-md-6 col-xs-12" data-filters="upcoming">
            <a href="#!" class="angled-img">
              <div class="img img-offset">
                <img src="assets/images/game-mirrormoon-500x375.jpg" alt="">
              </div>
              <div class="bottom-info">
                <h4>MirrorMoon</h4>
                <div class="date">
