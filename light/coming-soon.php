...
<body>
  ...
  <!-- Navbar -->
  <nav class="navbar-fire navbar navbar-default navbar-fixed-top navbar-small">
    <div class="container">
          ...
          <li class="dropdown dropdown-hover active">
            ...
            <div class="dropdown-menu" style="width: 320px;">
              ...
              <!--
                        -->
              <ul role="menu">
                <li class="active"><a href="coming-soon.php">Coming Soon</a>
                </li>
  ...
  <section class="content-wrap full">
    ...
    <!-- Preorder -->
    <section class="fire-banner">
      <div class="image" style="background-image: url(assets/images/banner-broken-age.jpg);">
      </div>

      <div class="info container align-center">
        <div>
          <img src="assets/images/logo-broken-age-400x197.png" alt="">
