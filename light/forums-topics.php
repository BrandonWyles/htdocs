...
<?php include ($svr.'inc/light/ftopic.php'); ?>
          ...
          <li class="dropdown dropdown-hover active">
            ...
            <div class="dropdown-menu" style="width: 320px;">
              <ul role="menu">
                ...
                <li class="active"><a href="forums-topics.php">Forums Topics</a>
                </li>
        ...
        <ul class="fire-forum mr-10">
          ...
          <li class="body">
            <ul class="sticky">
              ...
              <li class="cell-info">
                <a href="#!" class="title h4">Sticky Topic</a>
                <div class="description">
                  Started by:
                  <a href="#!">
                    <img alt="" src="assets/images/avatar-user-2.png" height="15" width="15">John Doe
                  </a>
                </div>
              </li>
            ...
            <ul>
              ...
              <li class="cell-info">
                <a href="#!" class="title h4">Normal Topic</a>
                <div class="description">
                  Started by:
                  <a href="#!">
                    <img alt="" src="assets/images/avatar-user-2.png" height="15" width="15">John Doe
            ...
            <ul class="closed">
              ...
              <li class="cell-info">
                <a href="#!" class="title h4">Closed Topic</a>
                <div class="description">
                  Started by:
                  <a href="#!">
                    <img alt="" src="assets/images/avatar-user-2.png" height="15" width="15">John Doe
