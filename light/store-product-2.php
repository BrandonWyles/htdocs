...
<?php include ($svr.'inc/light/head_five.php'); ?>
    ...
    <div class="tp-banner-container rs-fire">
      <div class="tp-banner">
        <ul>
          ...
          <!-- SLIDE NR. 2  -->
          <li data-thumb="assets/images/game-botanicula-6-500x375.jpg" data-saveperformance="on" data-transition="random-static" data-slotamount="7" data-masterspeed="700">
            <!-- MAIN IMAGE -->
            <img src="assets/images/dummy.png" alt="" data-lazyload="assets/images/game-botanicula-6-1920x1080.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
          ...
          <!-- SLIDE NR. 3  -->
          <li data-thumb="assets/images/game-botanicula-5-500x375.jpg" data-saveperformance="on" data-transition="random-static" data-slotamount="7" data-masterspeed="700">
            <!-- MAIN IMAGE -->
            <img src="assets/images/dummy.png" alt="" data-lazyload="assets/images/game-botanicula-5-1920x1080.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
            <!-- LAYERS -->
